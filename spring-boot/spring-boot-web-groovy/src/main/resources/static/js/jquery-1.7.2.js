      ...
      map: function (elems, callback, arg) {
        var value, key, ret = [],
            ...
            isArray = elems instanceof jQuery || length !== undefined
                && typeof length === "number" && ( ( length > 0 && elems[0]
                && elems[length - 1] ) || length === 0 || jQuery.isArray(
                    elems) );
...
// Convert String-formatted flags into Object-formatted ones and store in cache
  ...
  jQuery.extend({
    ...
    when: function (firstParam) {
      ...
      if (length > 1) {
        for (; i < length; i++) {
          if (args[i] && args[i].promise && jQuery.isFunction(
                  args[i].promise)) {
  ...
  jQuery.support = (function () {
    ...
    jQuery(function () {
      ...
      offsetSupport.fixedPosition = ( inner.offsetTop === 20 || inner.offsetTop
      === 15 );
      ...
      offsetSupport.subtractsBorderForOverflowNotVisible = ( inner.offsetTop
      === -5 );
...
// checks a cache object for emptiness
  ...
  function handleQueueMarkDefer(elem, type, src) {
    ...
    if (defer &&
      ...
      setTimeout(function () {
        if (!jQuery._data(elem, queueDataKey) && !jQuery._data(elem,
                markDataKey)) {
  ...
  jQuery.extend({
    ...
    attr: function (elem, name, value, pass) {
      ...
      if (value !== undefined) {
        ...
        } else if (hooks && "set" in hooks && notxml && (ret = hooks.set(elem,
      ...
      } else if (hooks && "get" in hooks && notxml && (ret = hooks.get(elem,
              name)) !== null) {
        return ret;
  ...
  var rformElems = /^(?:textarea|input|select)$/i,
      ...
      quickParse = function (selector) {
        ...
        if (quick) {
          ...
          quick[3] = quick[3] && new RegExp("(?:^|\\s)" + quick[3]
                  + "(?:\\s|$)");
        }
        return quick;
      },
    ...
    trigger: function (event, data, elem, onlyHandlers) {
      ...
      if (!onlyHandlers && !event.isDefaultPrevented()) {
        ...
        if ((!special._default || special._default.apply(elem.ownerDocument,
                data) === false) && !(type === "click" && jQuery.nodeName(elem,
          ...
          if (cur.disabled !== true) {
            ...
            for (i = 0; i < delegateCount; i++) {
              ...
              if (selMatch[sel] === undefined) {
                selMatch[sel] = (
                    handleObj.quick ? quickIs(cur, handleObj.quick) : jqcur.is(
                            sel)
                );
              }
              if (selMatch[sel]) {
        ...
        if (!prune) {
          ...
          for (i = 0; checkSet[i] != null; i++) {
            if (checkSet[i] && (checkSet[i] === true || checkSet[i].nodeType
                === 1 && Sizzle.contains(context, checkSet[i]))) {
              results.push(set[i]);
            }
          }
      ...
      if (matches) {
        ...
        Sizzle.matchesSelector = function (node, expr) {
          ...
          if (!Sizzle.isXML(node)) {
            try {
              if (pseudoWorks || !Expr.match.PSEUDO.test(expr) && !/!=/.test(
                      expr)) {
      ...
      for (i = 0, l = this.length; i < l; i++) {
        ...
        while (cur) {
          if (pos ? pos.index(cur) > -1 : jQuery.find.matchesSelector(cur,
            ...
            cur = cur.parentNode;
            if (!cur || !cur.ownerDocument || cur === context || cur.nodeType
                === 11) {
              break;
            }
          }
  ...
  jQuery.extend({
    ...
    clean: function (elems, context, fragment, scripts) {
      ...
      if (fragment) {
        ...
        for (i = 0; ret[i]; i++) {
          script = ret[i];
          if (scripts && jQuery.nodeName(script, "script") && (!script.type
            ...
            if (script.nodeType === 1) {
              var jsTags = jQuery.grep(script.getElementsByTagName("script"),
                  checkScriptType);
  ...
  if (document.defaultView && document.defaultView.getComputedStyle) {
    getComputedStyle = function (elem, name) {
      ...
      if ((defaultView = elem.ownerDocument.defaultView) &&
        ...
        if (ret === "" && !jQuery.contains(elem.ownerDocument.documentElement,
                elem)) {
      ...
      if (!jQuery.support.pixelMargin && computedStyle && rmargin.test(name)
          && rnumnonpx.test(ret)) {
        width = style.width;
        style.width = ret;
  ...
  function getWidthOrHeight(elem, name, extra) {
      ...
      if (extra !== "border") {
        for (; i < len; i += 2) {
          ...
          if (extra === "margin") {
            ...
            val -= parseFloat(
                    jQuery.css(elem, "border" + cssExpand[i] + "Width")) || 0;
          }
        }
      }
    ...
    if (extra) {
      for (; i < len; i += 2) {
        val += parseFloat(jQuery.css(elem, "padding" + cssExpand[i])) || 0;
        if (extra !== "padding") {
          val += parseFloat(jQuery.css(elem, "border" + cssExpand[i] + "Width"))
              || 0;
        }
        if (extra === "margin") {
          val += parseFloat(jQuery.css(elem, extra + cssExpand[i])) || 0;
    ...
    ajax: function (url, options) {
      ...
      function done(status, nativeStatusText, responses, headers) {
        ...
        var isSuccess,
            ...
            response = responses ? ajaxHandleResponses(s, jqXHR, responses)
                : undefined,
            lastModified,
            etag;
  ...
  jQuery.fn.extend({
      ...
      function doAnimation() {
        ...
        for (name in prop) {
          ...
          if (isElement && ( name === "height" || name === "width" )) {
            ...
            if (jQuery.css(this, "display") === "inline" &&
              ...
              if (!jQuery.support.inlineBlockNeedsLayout || defaultDisplay(
                      this.nodeName) === "inline") {
        ...
        for (p in prop) {
          ...
          if (rfxtypes.test(val)) {
            ...
            method = jQuery._data(this, "toggle" + p) || ( val === "toggle"
                    ? hidden ? "show" : "hide" : 0 );
            if (method) {
    ...
    stop: function (type, clearQueue, gotoEnd) {
      ...
      return this.each(function () {
        ...
        if (type == null) {
          for (index in data) {
            if (data[index] && data[index].stop && index.indexOf(".run")
                === index.length - 4) {
  ...
  jQuery.fx.prototype = {
    ...
    hide: function () {
      ...
      this.options.orig[this.prop] = jQuery._data(this.elem,
              "fxshow" + this.prop) || jQuery.style(this.elem, this.prop);
    ...
    if (!elemdisplay[nodeName]) {
      ...
      if (display === "none" || display === "") {
        ...
        if (!iframeDoc || !iframe.createElement) {
          ...
          iframeDoc.write(( jQuery.support.boxModel ? "<!doctype html>" : "" )
              + "<html><body>");
          iframeDoc.close();
        }
  ...
  if ("getBoundingClientRect" in document.documentElement) {
    getOffset = function (elem, doc, docElem, box) {
      ...
      var body = doc.body,
          ...
          scrollTop = win.pageYOffset || jQuery.support.boxModel
              && docElem.scrollTop || body.scrollTop,
          scrollLeft = win.pageXOffset || jQuery.support.boxModel
    ...
    getOffset = function (elem, doc, docElem) {
      ...
      while ((elem = elem.parentNode) && elem !== body && elem !== docElem) {
        if (jQuery.support.fixedPosition && prevComputedStyle.position
            === "fixed") {
          break;
        }
        ...
        if (elem === offsetParent) {
          ...
          if (jQuery.support.doesNotAddBorder
              && !(jQuery.support.doesAddBorderForTableAndCells && rtable.test(
                  elem.nodeName))) {
  ...
  jQuery.fn.extend({
    ...
    position: function () {
      ...
      parentOffset.left += parseFloat(
              jQuery.css(offsetParent[0], "borderLeftWidth")) || 0;
